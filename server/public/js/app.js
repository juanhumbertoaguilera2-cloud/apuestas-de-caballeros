  ...
  try {
    ...
    listEl.innerHTML = offers.map(o => `
      <div class="slip">
        ...
        <div class="slip-meta"><span>Cupo: <b>${o.copiesTaken}/${o.maxCopies}</b></span></div>
...
$('#c-double').addEventListener('change', () => { if ($('#c-double').checked) $('#c-triple').checked = false; });
$('#c-triple').addEventListener('change', () => { if ($('#c-triple').checked) $('#c-double').checked = false; });
